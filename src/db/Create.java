...
public class Create implements Operate {
    ...
    public void start() throws Exception {
        switch (ParseAccount.parseCreate(this)) {
            case 1:
    ...
    private void parseCreateTable() throws Exception {
        // 解析create-table语句，获取Table实例
        this.table = ParseAccount.parseTable(this.account, this.name);
    ...
    private void createDatabase() {
        ...
        System.out.println(dir.getPath());//输出创建文件夹的位置
        dir.mkdirs();//为该数据库创建文件夹
    }
    ...
    private void createTable() throws Exception {
        ...
        System.out.println(this.table.getTableName()+" 表创建成功！");
    }
    ...
    private void createIndex() throws Exception {
        ...
        Field field = null;
        // 找到待创建索引的属性所在列
        for (Field field1 : this.getTable().getAttributes()) {
